...
import Popup from '../../components/popup/PrescriptionPopup'
const Prescription = () => {

  const [data] = useState(prescriptionData)
  ...
  return (
    <div className={`pt-[6rem] pl-4 pr-4 font-poppinsFont bg-[#E6F1FD] h-[100vh]  pb-4 z-[-30] overflow-y-hidden`}>
      ...
      <div className='flex justify-between items-center flex-wrap mb-3 sm:mb-0'>
        <h1 className='text-xl font-bold tracking-wide mb-4 pt-4 '>Prescriptions</h1>
        ...
        <table className='w-full'>
          <thead>
            <tr>
              ...
              <th className='p-4 text-start border-b-2 border-[#E9EBED] tracking-wider text-sm  whitespace-nowrap'>Condition</th>
              <th className='p-4 text-start border-b-2 border-[#E9EBED] tracking-wider text-sm  whitespace-nowrap'>Prescription</th>
              <th className='p-4 text-start border-b-2 border-[#E9EBED] tracking-wider text-sm  whitespace-nowrap'>Doctor</th>
              <th className='p-4 text-start border-b-2 border-[#E9EBED] tracking-wider text-sm  whitespace-nowrap'>Date</th>
              <th className='p-4 text-start border-b-2 border-[#E9EBED] tracking-wider text-sm  whitespace-nowrap'>Action</th>
          ...
          <tbody>
            {records?.map((item, index) => (
              <tr key={index}>
                ...
                <td className='p-4 border-b-2 border-[#E9EBED] text-sm whitespace-nowrap'>{item?.prescription}</td>
                <td className='p-4 border-b-2 border-[#E9EBED] text-sm whitespace-nowrap'>{item?.doctor}</td>
                <td className='p-4 border-b-2 border-[#E9EBED]'>{item?.date}</td>
